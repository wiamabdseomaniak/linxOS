/**
 * Composant Button — bouton polymorphe basé sur Base UI.
 * Variants : default | outline | secondary | ghost | destructive | link.
 * Tailles : default | xs | sm | lg | icon | icon-xs | icon-sm | icon-lg.
 */
...
// Définition CVA : variants + tailles + états (hover, focus, disabled, aria-invalid).
...
// Bouton final — accepte toutes les props du primitif Base UI + le variant.
function Button({
  className,
  variant = "default",
  size = "default",
